                ...
                <div className='flex flex-col justify-center w-[50%] h-full  px-20 relative '>
                   ...
                   <TextType
                    ...
                    <div className='flex  pt-15 gap-5 w-full justify-center items-center text-xl font-bold'>
                        ...
                        <button className='px-6 text-xl font-bold py-3 bg-transparent border-1 hover:cursor-pointer hover:shadow-[1px_1px_0px_0px_rgb(0,0,0,1)] border-black shadow-[4px_4px_0px_0px_rgb(0,0,0,1)]'>Hire me</button>
                        <button className='px-6 text-xl font-bold py-3 bg-transparent border-1 hover:cursor-pointer hover:shadow-[1px_1px_0px_0px_rgb(0,0,0,1)] border-black shadow-[4px_4px_0px_0px_rgb(0,0,0,1)]'>View my work</button>
                    </div>
                </div>
